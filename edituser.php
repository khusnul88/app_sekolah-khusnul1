...
if(isset($_POST['simpan'])){
    ...
    $up = mysqli_query($conn, "update tbuser set nama_user='$nama',usernama='$username' where iduser=$iduser");
}
if($up){
...
<tr>
    ...
    <td>
    <input type="password" nama="password2" placeholder="password2" required>
</td>
</tr>
<tr>
    <td>
